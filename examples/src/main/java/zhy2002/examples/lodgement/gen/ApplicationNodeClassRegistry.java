...
class ApplicationNodeClassRegistry extends ClassRegistryImpl {
    ...
    private void loadChildNodeFactories() {
        ...
        setChildNodeFactory(MovedToCurrentAddressNode.class, new MovedToCurrentAddressNodeFactory());
        setChildNodeFactory(MovedToPreviousAddressNode.class, new MovedToPreviousAddressNodeFactory());
        setChildNodeFactory(MovedFromPreviousAddressNode.class, new MovedFromPreviousAddressNodeFactory());
        ...
        setChildNodeFactory(PersonTrustTypeNode.class, new PersonTrustTypeNodeFactory());
        setChildNodeFactory(PersonTrustNameNode.class, new PersonTrustNameNodeFactory());
        setChildNodeFactory(PersonTrustRegistrationDateNode.class, new PersonTrustRegistrationDateNodeFactory());
        setChildNodeFactory(PersonTrustCountryNode.class, new PersonTrustCountryNodeFactory());
        setChildNodeFactory(PersonTrustAddressNode.class, new PersonTrustAddressNodeFactory());
        setChildNodeFactory(PersonTrustSettlorNotRequiredReasonNode.class, new PersonTrustSettlorNotRequiredReasonNodeFactory());
        setChildNodeFactory(PersonTrustIndustryNode.class, new PersonTrustIndustryNodeFactory());
        setChildNodeFactory(PersonTrustNode.class, new PersonTrustNodeFactory());
        setChildNodeFactory(CreditCheckFlagNode.class, new CreditCheckFlagNodeFactory());
        setChildNodeFactory(ThirdPartyDisclosureFlagNode.class, new ThirdPartyDisclosureFlagNodeFactory());
        setChildNodeFactory(LegalActionNode.class, new LegalActionNodeFactory());
        setChildNodeFactory(PersonPrivacyNode.class, new PersonPrivacyNodeFactory());
        setChildNodeFactory(PersonOtherIncomeTypeNode.class, new PersonOtherIncomeTypeNodeFactory());
        ...
        setChildNodeFactory(PersonTypeOfChangeNode.class, new PersonTypeOfChangeNodeFactory());
        setChildNodeFactory(PersonMitigationMethodNode.class, new PersonMitigationMethodNodeFactory());
        setChildNodeFactory(PersonRepaymentDifficultyNode.class, new PersonRepaymentDifficultyNodeFactory());
