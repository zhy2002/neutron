...
import zhy2002.neutron.core.data.BigDecimalOption;
...
public abstract class BigDecimalUiNode<P extends ParentUiNode<?>> extends LeafUiNode<P, BigDecimal> {
    ...
    public static class SyncValueTextRule extends UiNodeRule<BigDecimalUiNode<?>> {

        private static ValueParser<BigDecimal> parser = new BigDecimalParser();

        public SyncValueTextRule(BigDecimalUiNode<?> owner) {
            super(owner);
        }
