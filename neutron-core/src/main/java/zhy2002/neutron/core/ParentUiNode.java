...
import zhy2002.neutron.core.exception.ChildAlreadyExistException;
import zhy2002.neutron.core.exception.ParentMismatchException;
...
public abstract class ParentUiNode<P extends ParentUiNode<?>> extends UiNode<P> {
    ...
    static class MaintainDirtyDescendantCountRule extends UiNodeRule<ParentUiNode<?>> {
        ...
        MaintainDirtyDescendantCountRule(ParentUiNode<?> owner) {
            super(owner);
        }
