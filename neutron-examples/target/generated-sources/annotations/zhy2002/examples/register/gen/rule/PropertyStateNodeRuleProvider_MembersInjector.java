...
public final class PropertyStateNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyStateNodeRuleProvider> {
  ...
  public PropertyStateNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyStateNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new PropertyStateNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyStateNodeRuleProvider instance) {
    if (instance == null) {
