...
public final class PhoneNumberNodeRuleProvider_MembersInjector
    implements MembersInjector<PhoneNumberNodeRuleProvider> {
  ...
  public PhoneNumberNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PhoneNumberNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new PhoneNumberNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PhoneNumberNodeRuleProvider instance) {
    if (instance == null) {
