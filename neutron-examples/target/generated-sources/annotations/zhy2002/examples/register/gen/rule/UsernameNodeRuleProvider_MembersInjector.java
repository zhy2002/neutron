...
public final class UsernameNodeRuleProvider_MembersInjector
    implements MembersInjector<UsernameNodeRuleProvider> {
  ...
  private final Provider<DefaultEmailByUsernameRule> defaultEmailByUsernameRuleProvider;

  public UsernameNodeRuleProvider_MembersInjector(
    ...
    assert defaultEmailByUsernameRuleProvider != null;
    this.defaultEmailByUsernameRuleProvider = defaultEmailByUsernameRuleProvider;
  }

  public static MembersInjector<UsernameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<DefaultEmailByUsernameRule> defaultEmailByUsernameRuleProvider) {
    return new UsernameNodeRuleProvider_MembersInjector(
        ...
        defaultEmailByUsernameRuleProvider);
  }

  @Override
  public void injectMembers(UsernameNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.defaultEmailByUsernameRuleProvider = defaultEmailByUsernameRuleProvider;
  }

  public static void injectDefaultEmailByUsernameRuleProvider(
      UsernameNodeRuleProvider instance,
      Provider<DefaultEmailByUsernameRule> defaultEmailByUsernameRuleProvider) {
    instance.defaultEmailByUsernameRuleProvider = defaultEmailByUsernameRuleProvider;
  }
}
