...
public final class AreaCodeNodeRuleProvider_MembersInjector
    implements MembersInjector<AreaCodeNodeRuleProvider> {
  ...
  public AreaCodeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AreaCodeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new AreaCodeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AreaCodeNodeRuleProvider instance) {
    if (instance == null) {
