...
public final class CompanyResponsibleLendNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyResponsibleLendNodeRuleProvider> {
  ...
  public CompanyResponsibleLendNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyResponsibleLendNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new CompanyResponsibleLendNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyResponsibleLendNodeRuleProvider instance) {
    if (instance == null) {
