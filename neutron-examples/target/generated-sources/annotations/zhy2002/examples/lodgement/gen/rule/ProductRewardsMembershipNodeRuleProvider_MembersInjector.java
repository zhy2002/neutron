...
public final class ProductRewardsMembershipNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductRewardsMembershipNodeRuleProvider> {
  ...
  public ProductRewardsMembershipNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductRewardsMembershipNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductRewardsMembershipNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductRewardsMembershipNodeRuleProvider instance) {
    if (instance == null) {
