...
public final class ThirdPartyCompanyNameNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyCompanyNameNodeRuleProvider> {
  ...
  public ThirdPartyCompanyNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyCompanyNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ThirdPartyCompanyNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyCompanyNameNodeRuleProvider instance) {
    if (instance == null) {
