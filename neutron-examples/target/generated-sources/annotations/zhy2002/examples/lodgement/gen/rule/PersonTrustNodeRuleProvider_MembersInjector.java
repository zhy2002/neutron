...
public final class PersonTrustNodeRuleProvider_MembersInjector
    implements MembersInjector<PersonTrustNodeRuleProvider> {
  ...
  public PersonTrustNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PersonTrustNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new PersonTrustNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PersonTrustNodeRuleProvider instance) {
    if (instance == null) {
