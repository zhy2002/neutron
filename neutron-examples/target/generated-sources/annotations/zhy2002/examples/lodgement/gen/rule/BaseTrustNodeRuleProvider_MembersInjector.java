...
public final class BaseTrustNodeRuleProvider_MembersInjector<N extends BaseTrustNode<?>>
    implements MembersInjector<BaseTrustNodeRuleProvider<N>> {
  ...
  public BaseTrustNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseTrustNode<?>> MembersInjector<BaseTrustNodeRuleProvider<N>> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new BaseTrustNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseTrustNodeRuleProvider<N> instance) {
    if (instance == null) {
