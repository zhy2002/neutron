...
public final class EmploymentTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<EmploymentTypeNodeRuleProvider> {
  ...
  private final Provider<EmploymentTypeChangedRule> employmentTypeChangedRuleProvider;

  public EmploymentTypeNodeRuleProvider_MembersInjector(
    ...
    assert employmentTypeChangedRuleProvider != null;
    this.employmentTypeChangedRuleProvider = employmentTypeChangedRuleProvider;
  }

  public static MembersInjector<EmploymentTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<EmploymentTypeChangedRule> employmentTypeChangedRuleProvider) {
    return new EmploymentTypeNodeRuleProvider_MembersInjector(
        ...
        employmentTypeChangedRuleProvider);
  }

  @Override
  public void injectMembers(EmploymentTypeNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.employmentTypeChangedRuleProvider = employmentTypeChangedRuleProvider;
  }

  public static void injectEmploymentTypeChangedRuleProvider(
      EmploymentTypeNodeRuleProvider instance,
      Provider<EmploymentTypeChangedRule> employmentTypeChangedRuleProvider) {
    instance.employmentTypeChangedRuleProvider = employmentTypeChangedRuleProvider;
  }
}
