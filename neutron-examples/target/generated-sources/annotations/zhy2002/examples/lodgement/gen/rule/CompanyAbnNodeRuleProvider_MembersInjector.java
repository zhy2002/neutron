...
public final class CompanyAbnNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyAbnNodeRuleProvider> {
  ...
  public CompanyAbnNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyAbnNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyAbnNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyAbnNodeRuleProvider instance) {
    if (instance == null) {
