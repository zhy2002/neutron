...
public final class AddressNodeRuleProvider_MembersInjector<N extends AddressNode<?>>
    implements MembersInjector<AddressNodeRuleProvider<N>> {
  ...
  private final Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider;

  public AddressNodeRuleProvider_MembersInjector(
    ...
    assert updateAddressRefListRuleProvider != null;
    this.updateAddressRefListRuleProvider = updateAddressRefListRuleProvider;
  }

  public static <N extends AddressNode<?>> MembersInjector<AddressNodeRuleProvider<N>> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new AddressNodeRuleProvider_MembersInjector<N>(
        clearErrorsForDisabledNodeRuleProvider,
        objectValueRequiredValidationRuleProvider,
        updateObjectHasValueRuleProvider,
        updateAddressRefListRuleProvider);
  }

  @Override
  public void injectMembers(AddressNodeRuleProvider<N> instance) {
    if (instance == null) {
    ...
    instance.updateAddressRefListRuleProvider = updateAddressRefListRuleProvider;
  }

  public static <N extends AddressNode<?>> void injectUpdateAddressRefListRuleProvider(
      AddressNodeRuleProvider<N> instance,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    instance.updateAddressRefListRuleProvider = updateAddressRefListRuleProvider;
  }
}
