...
public final class UnemployedOnBenefitFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<UnemployedOnBenefitFlagNodeRuleProvider> {
  ...
  public UnemployedOnBenefitFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<UnemployedOnBenefitFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new UnemployedOnBenefitFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(UnemployedOnBenefitFlagNodeRuleProvider instance) {
    if (instance == null) {
