...
public final class ProductRepaymentFrequencyNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductRepaymentFrequencyNodeRuleProvider> {
  ...
  public ProductRepaymentFrequencyNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductRepaymentFrequencyNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductRepaymentFrequencyNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductRepaymentFrequencyNodeRuleProvider instance) {
    if (instance == null) {
