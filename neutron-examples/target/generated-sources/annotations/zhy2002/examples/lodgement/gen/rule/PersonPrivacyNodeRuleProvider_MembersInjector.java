...
public final class PersonPrivacyNodeRuleProvider_MembersInjector
    implements MembersInjector<PersonPrivacyNodeRuleProvider> {
  ...
  public PersonPrivacyNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PersonPrivacyNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new PersonPrivacyNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PersonPrivacyNodeRuleProvider instance) {
    if (instance == null) {
