...
public final class ProductPackageNameNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductPackageNameNodeRuleProvider> {
  ...
  public ProductPackageNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductPackageNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductPackageNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductPackageNameNodeRuleProvider instance) {
    if (instance == null) {
