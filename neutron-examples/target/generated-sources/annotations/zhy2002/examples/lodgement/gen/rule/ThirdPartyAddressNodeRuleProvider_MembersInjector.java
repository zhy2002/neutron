...
public final class ThirdPartyAddressNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyAddressNodeRuleProvider> {
  ...
  public ThirdPartyAddressNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyAddressNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new ThirdPartyAddressNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyAddressNodeRuleProvider instance) {
    if (instance == null) {
    ...
    ((AddressNodeRuleProvider) instance).updateAddressRefListRuleProvider =
        updateAddressRefListRuleProvider;
  }
}
