...
public final class ProductSpecificFeaturesFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductSpecificFeaturesFlagNodeRuleProvider> {
  ...
  public ProductSpecificFeaturesFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductSpecificFeaturesFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ProductSpecificFeaturesFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductSpecificFeaturesFlagNodeRuleProvider instance) {
    if (instance == null) {
