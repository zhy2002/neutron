...
public final class VehicleModelNodeRuleProvider_MembersInjector
    implements MembersInjector<VehicleModelNodeRuleProvider> {
  ...
  public VehicleModelNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<VehicleModelNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new VehicleModelNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(VehicleModelNodeRuleProvider instance) {
    if (instance == null) {
