...
public final class LoanOwingAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<LoanOwingAmountNodeRuleProvider> {
  ...
  public LoanOwingAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<LoanOwingAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new LoanOwingAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(LoanOwingAmountNodeRuleProvider instance) {
    if (instance == null) {
