...
public final class ResponsibleSignificantChangeFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ResponsibleSignificantChangeFlagNodeRuleProvider> {
  ...
  private final Provider<ResponsibleSignificantChangeRule> responsibleSignificantChangeRuleProvider;

  public ResponsibleSignificantChangeFlagNodeRuleProvider_MembersInjector(
    ...
    assert responsibleSignificantChangeRuleProvider != null;
    this.responsibleSignificantChangeRuleProvider = responsibleSignificantChangeRuleProvider;
  }

  public static MembersInjector<ResponsibleSignificantChangeFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<ResponsibleSignificantChangeRule> responsibleSignificantChangeRuleProvider) {
    return new ResponsibleSignificantChangeFlagNodeRuleProvider_MembersInjector(
        ...
        responsibleSignificantChangeRuleProvider);
  }

  @Override
  public void injectMembers(ResponsibleSignificantChangeFlagNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.responsibleSignificantChangeRuleProvider = responsibleSignificantChangeRuleProvider;
  }

  public static void injectResponsibleSignificantChangeRuleProvider(
      ResponsibleSignificantChangeFlagNodeRuleProvider instance,
      Provider<ResponsibleSignificantChangeRule> responsibleSignificantChangeRuleProvider) {
    instance.responsibleSignificantChangeRuleProvider = responsibleSignificantChangeRuleProvider;
  }
}
