...
public final class PropertyTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyTypeNodeRuleProvider> {
  ...
  public PropertyTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new PropertyTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyTypeNodeRuleProvider instance) {
    if (instance == null) {
