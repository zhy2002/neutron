...
public final class ProductTotalLoanAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTotalLoanAmountNodeRuleProvider> {
  ...
  public ProductTotalLoanAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTotalLoanAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductTotalLoanAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTotalLoanAmountNodeRuleProvider instance) {
    if (instance == null) {
