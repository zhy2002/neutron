...
public final class ProductNameNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductNameNodeRuleProvider> {
  ...
  public ProductNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductNameNodeRuleProvider instance) {
    if (instance == null) {
