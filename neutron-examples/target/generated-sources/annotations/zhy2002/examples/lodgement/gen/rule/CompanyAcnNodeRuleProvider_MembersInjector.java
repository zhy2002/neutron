...
public final class CompanyAcnNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyAcnNodeRuleProvider> {
  ...
  public CompanyAcnNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyAcnNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyAcnNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyAcnNodeRuleProvider instance) {
    if (instance == null) {
