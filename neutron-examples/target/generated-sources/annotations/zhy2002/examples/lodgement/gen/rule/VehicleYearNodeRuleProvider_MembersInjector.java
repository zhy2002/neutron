...
public final class VehicleYearNodeRuleProvider_MembersInjector
    implements MembersInjector<VehicleYearNodeRuleProvider> {
  ...
  public VehicleYearNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<VehicleYearNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new VehicleYearNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(VehicleYearNodeRuleProvider instance) {
    if (instance == null) {
