...
public final class ProductGroupNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductGroupNodeRuleProvider> {
  ...
  public ProductGroupNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductGroupNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductGroupNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductGroupNodeRuleProvider instance) {
    if (instance == null) {
