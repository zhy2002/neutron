...
public final class ProductCreditCardFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductCreditCardFlagNodeRuleProvider> {
  ...
  public ProductCreditCardFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductCreditCardFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ProductCreditCardFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductCreditCardFlagNodeRuleProvider instance) {
    if (instance == null) {
