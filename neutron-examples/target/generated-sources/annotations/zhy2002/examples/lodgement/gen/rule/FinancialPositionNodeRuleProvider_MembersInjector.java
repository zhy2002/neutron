...
public final class FinancialPositionNodeRuleProvider_MembersInjector
    implements MembersInjector<FinancialPositionNodeRuleProvider> {
  ...
  private final Provider<FinancialPositionChangedRule> financialPositionChangedRuleProvider;

  public FinancialPositionNodeRuleProvider_MembersInjector(
    ...
    assert financialPositionChangedRuleProvider != null;
    this.financialPositionChangedRuleProvider = financialPositionChangedRuleProvider;
  }

  public static MembersInjector<FinancialPositionNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<FinancialPositionChangedRule> financialPositionChangedRuleProvider) {
    return new FinancialPositionNodeRuleProvider_MembersInjector(
        clearErrorsForDisabledNodeRuleProvider,
        objectValueRequiredValidationRuleProvider,
        updateObjectHasValueRuleProvider,
        financialPositionChangedRuleProvider);
  }

  @Override
  public void injectMembers(FinancialPositionNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.financialPositionChangedRuleProvider = financialPositionChangedRuleProvider;
  }

  public static void injectFinancialPositionChangedRuleProvider(
      FinancialPositionNodeRuleProvider instance,
      Provider<FinancialPositionChangedRule> financialPositionChangedRuleProvider) {
    instance.financialPositionChangedRuleProvider = financialPositionChangedRuleProvider;
  }
}
