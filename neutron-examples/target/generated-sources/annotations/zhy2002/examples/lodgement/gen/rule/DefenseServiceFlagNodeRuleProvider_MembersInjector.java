...
public final class DefenseServiceFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<DefenseServiceFlagNodeRuleProvider> {
  ...
  public DefenseServiceFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<DefenseServiceFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new DefenseServiceFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(DefenseServiceFlagNodeRuleProvider instance) {
    if (instance == null) {
