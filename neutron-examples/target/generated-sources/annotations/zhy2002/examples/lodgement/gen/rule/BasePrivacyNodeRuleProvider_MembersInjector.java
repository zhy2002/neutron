...
public final class BasePrivacyNodeRuleProvider_MembersInjector<N extends BasePrivacyNode<?>>
    implements MembersInjector<BasePrivacyNodeRuleProvider<N>> {
  ...
  public BasePrivacyNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BasePrivacyNode<?>>
      MembersInjector<BasePrivacyNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
          Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new BasePrivacyNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BasePrivacyNodeRuleProvider<N> instance) {
    if (instance == null) {
