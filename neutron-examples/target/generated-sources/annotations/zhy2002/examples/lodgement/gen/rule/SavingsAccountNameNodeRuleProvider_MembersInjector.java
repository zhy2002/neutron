...
public final class SavingsAccountNameNodeRuleProvider_MembersInjector
    implements MembersInjector<SavingsAccountNameNodeRuleProvider> {
  ...
  public SavingsAccountNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SavingsAccountNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new SavingsAccountNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SavingsAccountNameNodeRuleProvider instance) {
    if (instance == null) {
