...
public final class StudentTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<StudentTypeNodeRuleProvider> {
  ...
  public StudentTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<StudentTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new StudentTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(StudentTypeNodeRuleProvider instance) {
    if (instance == null) {
