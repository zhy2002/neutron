...
public final class ThirdPartyDisclosureFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyDisclosureFlagNodeRuleProvider> {
  ...
  public ThirdPartyDisclosureFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyDisclosureFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ThirdPartyDisclosureFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyDisclosureFlagNodeRuleProvider instance) {
    if (instance == null) {
