...
public final class ProductRewardsProgramNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductRewardsProgramNodeRuleProvider> {
  ...
  public ProductRewardsProgramNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductRewardsProgramNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductRewardsProgramNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductRewardsProgramNodeRuleProvider instance) {
    if (instance == null) {
