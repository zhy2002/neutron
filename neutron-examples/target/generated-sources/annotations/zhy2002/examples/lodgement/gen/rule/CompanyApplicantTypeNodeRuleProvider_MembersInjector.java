...
public final class CompanyApplicantTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyApplicantTypeNodeRuleProvider> {
  ...
  public CompanyApplicantTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyApplicantTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyApplicantTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyApplicantTypeNodeRuleProvider instance) {
    if (instance == null) {
