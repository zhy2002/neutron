...
public final class RentedFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<RentedFlagNodeRuleProvider> {
  ...
  public RentedFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<RentedFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new RentedFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(RentedFlagNodeRuleProvider instance) {
    if (instance == null) {
