...
public final class HousingStatusNodeRuleProvider_MembersInjector
    implements MembersInjector<HousingStatusNodeRuleProvider> {
  ...
  public HousingStatusNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<HousingStatusNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new HousingStatusNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(HousingStatusNodeRuleProvider instance) {
    if (instance == null) {
