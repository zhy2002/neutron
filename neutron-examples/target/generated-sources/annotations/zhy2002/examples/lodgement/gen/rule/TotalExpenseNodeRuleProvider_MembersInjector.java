...
public final class TotalExpenseNodeRuleProvider_MembersInjector
    implements MembersInjector<TotalExpenseNodeRuleProvider> {
  ...
  public TotalExpenseNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TotalExpenseNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new TotalExpenseNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TotalExpenseNodeRuleProvider instance) {
    if (instance == null) {
