...
public final class EstimatedMarketValueNodeRuleProvider_MembersInjector
    implements MembersInjector<EstimatedMarketValueNodeRuleProvider> {
  ...
  public EstimatedMarketValueNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<EstimatedMarketValueNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new EstimatedMarketValueNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(EstimatedMarketValueNodeRuleProvider instance) {
    if (instance == null) {
