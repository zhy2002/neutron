...
public final class ContractPriceNodeRuleProvider_MembersInjector
    implements MembersInjector<ContractPriceNodeRuleProvider> {
  ...
  public ContractPriceNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ContractPriceNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ContractPriceNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ContractPriceNodeRuleProvider instance) {
    if (instance == null) {
