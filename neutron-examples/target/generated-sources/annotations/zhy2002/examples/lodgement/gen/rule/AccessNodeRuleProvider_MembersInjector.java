...
public final class AccessNodeRuleProvider_MembersInjector
    implements MembersInjector<AccessNodeRuleProvider> {
  ...
  public AccessNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AccessNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new AccessNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AccessNodeRuleProvider instance) {
    if (instance == null) {
