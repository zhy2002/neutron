...
public final class OtherIncomePreviousYearNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherIncomePreviousYearNodeRuleProvider> {
  ...
  public OtherIncomePreviousYearNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherIncomePreviousYearNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new OtherIncomePreviousYearNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherIncomePreviousYearNodeRuleProvider instance) {
    if (instance == null) {
