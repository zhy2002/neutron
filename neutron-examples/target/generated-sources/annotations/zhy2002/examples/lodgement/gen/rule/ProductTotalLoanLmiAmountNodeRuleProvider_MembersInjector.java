...
public final class ProductTotalLoanLmiAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTotalLoanLmiAmountNodeRuleProvider> {
  ...
  public ProductTotalLoanLmiAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTotalLoanLmiAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductTotalLoanLmiAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTotalLoanLmiAmountNodeRuleProvider instance) {
    if (instance == null) {
