...
public final class TotalAssetNodeRuleProvider_MembersInjector
    implements MembersInjector<TotalAssetNodeRuleProvider> {
  ...
  public TotalAssetNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TotalAssetNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new TotalAssetNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TotalAssetNodeRuleProvider instance) {
    if (instance == null) {
