...
public final class DateOfBirthNodeRuleProvider_MembersInjector
    implements MembersInjector<DateOfBirthNodeRuleProvider> {
  ...
  public DateOfBirthNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<DateOfBirthNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<DobRangeValidationRule> dobRangeValidationRuleProvider) {
    return new DateOfBirthNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(DateOfBirthNodeRuleProvider instance) {
    if (instance == null) {
