...
public final class LoanLimitAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<LoanLimitAmountNodeRuleProvider> {
  ...
  public LoanLimitAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<LoanLimitAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new LoanLimitAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(LoanLimitAmountNodeRuleProvider instance) {
    if (instance == null) {
