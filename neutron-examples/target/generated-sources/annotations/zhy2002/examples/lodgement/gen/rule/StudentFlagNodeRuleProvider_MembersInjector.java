...
public final class StudentFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<StudentFlagNodeRuleProvider> {
  ...
  public StudentFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<StudentFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new StudentFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(StudentFlagNodeRuleProvider instance) {
    if (instance == null) {
