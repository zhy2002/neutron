...
public final class BaseCountryNodeRuleProvider_MembersInjector<N extends BaseCountryNode<?>>
    implements MembersInjector<BaseCountryNodeRuleProvider<N>> {
  ...
  public BaseCountryNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseCountryNode<?>>
      MembersInjector<BaseCountryNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<PatternValidationRule> patternValidationRuleProvider,
          Provider<LengthValidationRule> lengthValidationRuleProvider,
          Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new BaseCountryNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseCountryNodeRuleProvider<N> instance) {
    if (instance == null) {
