...
public final class PropertyAddressNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyAddressNodeRuleProvider> {
  ...
  public PropertyAddressNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyAddressNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new PropertyAddressNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyAddressNodeRuleProvider instance) {
    if (instance == null) {
