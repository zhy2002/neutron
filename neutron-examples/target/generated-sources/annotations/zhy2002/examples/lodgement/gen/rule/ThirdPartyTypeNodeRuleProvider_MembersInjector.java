...
public final class ThirdPartyTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyTypeNodeRuleProvider> {
  ...
  public ThirdPartyTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ThirdPartyTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyTypeNodeRuleProvider instance) {
    if (instance == null) {
