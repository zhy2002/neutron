...
public final class ProductConstructionApplicationFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductConstructionApplicationFlagNodeRuleProvider> {
  ...
  public ProductConstructionApplicationFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductConstructionApplicationFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ProductConstructionApplicationFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductConstructionApplicationFlagNodeRuleProvider instance) {
    if (instance == null) {
