...
public final class ProductNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductNodeRuleProvider> {
  ...
  public ProductNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new ProductNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductNodeRuleProvider instance) {
    if (instance == null) {
