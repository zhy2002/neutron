...
public final class MobileNumberNodeRuleProvider_MembersInjector
    implements MembersInjector<MobileNumberNodeRuleProvider> {
  ...
  public MobileNumberNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<MobileNumberNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new MobileNumberNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(MobileNumberNodeRuleProvider instance) {
    if (instance == null) {
