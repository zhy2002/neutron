...
public final class OtherAssetTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherAssetTypeNodeRuleProvider> {
  ...
  public OtherAssetTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherAssetTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new OtherAssetTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherAssetTypeNodeRuleProvider instance) {
    if (instance == null) {
