...
public final class CompanyRegistrationDateNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyRegistrationDateNodeRuleProvider> {
  ...
  public CompanyRegistrationDateNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyRegistrationDateNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyRegistrationDateNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyRegistrationDateNodeRuleProvider instance) {
    if (instance == null) {
