...
public final class OtherLiabilityAmountOwningNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherLiabilityAmountOwningNodeRuleProvider> {
  ...
  public OtherLiabilityAmountOwningNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherLiabilityAmountOwningNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new OtherLiabilityAmountOwningNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherLiabilityAmountOwningNodeRuleProvider instance) {
    if (instance == null) {
