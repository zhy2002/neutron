...
public final class PropertyNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyNodeRuleProvider> {
  ...
  public PropertyNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new PropertyNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyNodeRuleProvider instance) {
    if (instance == null) {
