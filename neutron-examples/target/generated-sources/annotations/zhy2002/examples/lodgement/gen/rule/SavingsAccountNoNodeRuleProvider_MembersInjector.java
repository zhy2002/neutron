...
public final class SavingsAccountNoNodeRuleProvider_MembersInjector
    implements MembersInjector<SavingsAccountNoNodeRuleProvider> {
  ...
  public SavingsAccountNoNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SavingsAccountNoNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new SavingsAccountNoNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SavingsAccountNoNodeRuleProvider instance) {
    if (instance == null) {
