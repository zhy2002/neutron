...
public final class BaseResponsibleLendNodeRuleProvider_MembersInjector<
        N extends BaseResponsibleLendNode<?>>
    implements MembersInjector<BaseResponsibleLendNodeRuleProvider<N>> {
  ...
  public BaseResponsibleLendNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseResponsibleLendNode<?>>
      MembersInjector<BaseResponsibleLendNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
          Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new BaseResponsibleLendNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseResponsibleLendNodeRuleProvider<N> instance) {
    if (instance == null) {
