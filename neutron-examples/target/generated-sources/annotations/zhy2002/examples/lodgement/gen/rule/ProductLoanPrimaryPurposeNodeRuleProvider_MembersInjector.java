...
public final class ProductLoanPrimaryPurposeNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductLoanPrimaryPurposeNodeRuleProvider> {
  ...
  public ProductLoanPrimaryPurposeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductLoanPrimaryPurposeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductLoanPrimaryPurposeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductLoanPrimaryPurposeNodeRuleProvider instance) {
    if (instance == null) {
