...
public final class BeingPurchasedFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<BeingPurchasedFlagNodeRuleProvider> {
  ...
  public BeingPurchasedFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<BeingPurchasedFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new BeingPurchasedFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(BeingPurchasedFlagNodeRuleProvider instance) {
    if (instance == null) {
