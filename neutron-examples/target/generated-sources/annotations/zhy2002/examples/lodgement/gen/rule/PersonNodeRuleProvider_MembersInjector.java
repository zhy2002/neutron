...
public final class PersonNodeRuleProvider_MembersInjector
    implements MembersInjector<PersonNodeRuleProvider> {
  ...
  private final Provider<UpdatePersonNodeLabelRule> updatePersonNodeLabelRuleProvider;

  public PersonNodeRuleProvider_MembersInjector(
    ...
    assert updatePersonNodeLabelRuleProvider != null;
    this.updatePersonNodeLabelRuleProvider = updatePersonNodeLabelRuleProvider;
  }

  public static MembersInjector<PersonNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdatePersonNodeLabelRule> updatePersonNodeLabelRuleProvider) {
    return new PersonNodeRuleProvider_MembersInjector(
        clearErrorsForDisabledNodeRuleProvider,
        objectValueRequiredValidationRuleProvider,
        updateObjectHasValueRuleProvider,
        updatePersonNodeLabelRuleProvider);
  }

  @Override
  public void injectMembers(PersonNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.updatePersonNodeLabelRuleProvider = updatePersonNodeLabelRuleProvider;
  }

  public static void injectUpdatePersonNodeLabelRuleProvider(
      PersonNodeRuleProvider instance,
      Provider<UpdatePersonNodeLabelRule> updatePersonNodeLabelRuleProvider) {
    instance.updatePersonNodeLabelRuleProvider = updatePersonNodeLabelRuleProvider;
  }
}
