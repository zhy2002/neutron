...
public final class ProfitThisYearNodeRuleProvider_MembersInjector
    implements MembersInjector<ProfitThisYearNodeRuleProvider> {
  ...
  public ProfitThisYearNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProfitThisYearNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProfitThisYearNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProfitThisYearNodeRuleProvider instance) {
    if (instance == null) {
