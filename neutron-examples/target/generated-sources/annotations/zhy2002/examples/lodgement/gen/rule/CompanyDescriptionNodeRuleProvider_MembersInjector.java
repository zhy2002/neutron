...
public final class CompanyDescriptionNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyDescriptionNodeRuleProvider> {
  ...
  public CompanyDescriptionNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyDescriptionNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyDescriptionNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyDescriptionNodeRuleProvider instance) {
    if (instance == null) {
