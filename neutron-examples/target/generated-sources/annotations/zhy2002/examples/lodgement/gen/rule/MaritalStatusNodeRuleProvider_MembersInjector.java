...
public final class MaritalStatusNodeRuleProvider_MembersInjector
    implements MembersInjector<MaritalStatusNodeRuleProvider> {
  ...
  public MaritalStatusNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<MaritalStatusNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new MaritalStatusNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(MaritalStatusNodeRuleProvider instance) {
    if (instance == null) {
