...
public final class EmploymentStatusNodeRuleProvider_MembersInjector
    implements MembersInjector<EmploymentStatusNodeRuleProvider> {
  ...
  public EmploymentStatusNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<EmploymentStatusNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new EmploymentStatusNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(EmploymentStatusNodeRuleProvider instance) {
    if (instance == null) {
