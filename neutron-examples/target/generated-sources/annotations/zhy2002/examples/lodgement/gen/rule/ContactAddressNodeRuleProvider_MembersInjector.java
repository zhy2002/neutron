...
public final class ContactAddressNodeRuleProvider_MembersInjector
    implements MembersInjector<ContactAddressNodeRuleProvider> {
  ...
  public ContactAddressNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ContactAddressNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new ContactAddressNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ContactAddressNodeRuleProvider instance) {
    if (instance == null) {
