...
public final class TrustNameNodeRuleProvider_MembersInjector
    implements MembersInjector<TrustNameNodeRuleProvider> {
  ...
  public TrustNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TrustNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new TrustNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TrustNameNodeRuleProvider instance) {
    if (instance == null) {
