...
public final class ExpenseNodeRuleProvider_MembersInjector
    implements MembersInjector<ExpenseNodeRuleProvider> {
  ...
  public ExpenseNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ExpenseNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new ExpenseNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ExpenseNodeRuleProvider instance) {
    if (instance == null) {
