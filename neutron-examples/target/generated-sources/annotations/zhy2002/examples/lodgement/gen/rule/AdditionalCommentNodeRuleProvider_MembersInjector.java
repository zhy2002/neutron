...
public final class AdditionalCommentNodeRuleProvider_MembersInjector
    implements MembersInjector<AdditionalCommentNodeRuleProvider> {
  ...
  public AdditionalCommentNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AdditionalCommentNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new AdditionalCommentNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AdditionalCommentNodeRuleProvider instance) {
    if (instance == null) {
