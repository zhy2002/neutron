...
public final class SavingsAccountNodeRuleProvider_MembersInjector
    implements MembersInjector<SavingsAccountNodeRuleProvider> {
  ...
  public SavingsAccountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SavingsAccountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new SavingsAccountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SavingsAccountNodeRuleProvider instance) {
    if (instance == null) {
