...
public final class CompanyRegisteredNameNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyRegisteredNameNodeRuleProvider> {
  ...
  public CompanyRegisteredNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyRegisteredNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyRegisteredNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyRegisteredNameNodeRuleProvider instance) {
    if (instance == null) {
