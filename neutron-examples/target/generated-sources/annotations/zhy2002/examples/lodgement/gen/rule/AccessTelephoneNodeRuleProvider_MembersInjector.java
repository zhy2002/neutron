...
public final class AccessTelephoneNodeRuleProvider_MembersInjector
    implements MembersInjector<AccessTelephoneNodeRuleProvider> {
  ...
  public AccessTelephoneNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AccessTelephoneNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new AccessTelephoneNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AccessTelephoneNodeRuleProvider instance) {
    if (instance == null) {
