...
public final class CompanyContactNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyContactNodeRuleProvider> {
  ...
  public CompanyContactNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyContactNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new CompanyContactNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyContactNodeRuleProvider instance) {
    if (instance == null) {
