...
public final class ProductRequestedAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductRequestedAmountNodeRuleProvider> {
  ...
  public ProductRequestedAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductRequestedAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductRequestedAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductRequestedAmountNodeRuleProvider instance) {
    if (instance == null) {
