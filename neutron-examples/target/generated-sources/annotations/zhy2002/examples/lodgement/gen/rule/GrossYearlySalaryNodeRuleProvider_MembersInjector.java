...
public final class GrossYearlySalaryNodeRuleProvider_MembersInjector
    implements MembersInjector<GrossYearlySalaryNodeRuleProvider> {
  ...
  public GrossYearlySalaryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<GrossYearlySalaryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new GrossYearlySalaryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(GrossYearlySalaryNodeRuleProvider instance) {
    if (instance == null) {
