...
public final class ProductRateLockFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductRateLockFlagNodeRuleProvider> {
  ...
  public ProductRateLockFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductRateLockFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ProductRateLockFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductRateLockFlagNodeRuleProvider instance) {
    if (instance == null) {
