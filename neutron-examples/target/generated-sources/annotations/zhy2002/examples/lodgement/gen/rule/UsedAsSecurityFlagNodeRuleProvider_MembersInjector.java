...
public final class UsedAsSecurityFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<UsedAsSecurityFlagNodeRuleProvider> {
  ...
  public UsedAsSecurityFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<UsedAsSecurityFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new UsedAsSecurityFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(UsedAsSecurityFlagNodeRuleProvider instance) {
    if (instance == null) {
