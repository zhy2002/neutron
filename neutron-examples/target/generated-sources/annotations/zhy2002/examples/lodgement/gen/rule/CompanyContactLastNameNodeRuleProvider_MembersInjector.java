...
public final class CompanyContactLastNameNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyContactLastNameNodeRuleProvider> {
  ...
  public CompanyContactLastNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyContactLastNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyContactLastNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyContactLastNameNodeRuleProvider instance) {
    if (instance == null) {
