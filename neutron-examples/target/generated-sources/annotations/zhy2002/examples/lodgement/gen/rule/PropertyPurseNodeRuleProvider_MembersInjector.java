...
public final class PropertyPurseNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyPurseNodeRuleProvider> {
  ...
  public PropertyPurseNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyPurseNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new PropertyPurseNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyPurseNodeRuleProvider instance) {
    if (instance == null) {
