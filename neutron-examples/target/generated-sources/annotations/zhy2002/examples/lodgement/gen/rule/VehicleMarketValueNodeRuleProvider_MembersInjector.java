...
public final class VehicleMarketValueNodeRuleProvider_MembersInjector
    implements MembersInjector<VehicleMarketValueNodeRuleProvider> {
  ...
  public VehicleMarketValueNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<VehicleMarketValueNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new VehicleMarketValueNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(VehicleMarketValueNodeRuleProvider instance) {
    if (instance == null) {
