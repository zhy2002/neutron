...
public final class ThirdPartyFirstNameNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyFirstNameNodeRuleProvider> {
  ...
  public ThirdPartyFirstNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyFirstNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ThirdPartyFirstNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyFirstNameNodeRuleProvider instance) {
    if (instance == null) {
