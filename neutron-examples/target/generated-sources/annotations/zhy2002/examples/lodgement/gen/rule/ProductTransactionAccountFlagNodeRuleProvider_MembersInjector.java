...
public final class ProductTransactionAccountFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTransactionAccountFlagNodeRuleProvider> {
  ...
  public ProductTransactionAccountFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTransactionAccountFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ProductTransactionAccountFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTransactionAccountFlagNodeRuleProvider instance) {
    if (instance == null) {
