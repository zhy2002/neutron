...
public final class MonthNodeRuleProvider_MembersInjector
    implements MembersInjector<MonthNodeRuleProvider> {
  ...
  public MonthNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<MonthNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new MonthNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(MonthNodeRuleProvider instance) {
    if (instance == null) {
