...
public final class ResponsibleTypeOfChangeNodeRuleProvider_MembersInjector
    implements MembersInjector<ResponsibleTypeOfChangeNodeRuleProvider> {
  ...
  public ResponsibleTypeOfChangeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ResponsibleTypeOfChangeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ResponsibleTypeOfChangeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ResponsibleTypeOfChangeNodeRuleProvider instance) {
    if (instance == null) {
