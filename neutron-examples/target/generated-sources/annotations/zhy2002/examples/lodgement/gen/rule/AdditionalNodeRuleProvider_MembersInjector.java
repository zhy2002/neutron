...
public final class AdditionalNodeRuleProvider_MembersInjector
    implements MembersInjector<AdditionalNodeRuleProvider> {
  ...
  public AdditionalNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AdditionalNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new AdditionalNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AdditionalNodeRuleProvider instance) {
    if (instance == null) {
