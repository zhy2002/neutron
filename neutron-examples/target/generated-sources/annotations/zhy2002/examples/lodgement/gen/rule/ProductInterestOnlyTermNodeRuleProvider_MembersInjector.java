...
public final class ProductInterestOnlyTermNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductInterestOnlyTermNodeRuleProvider> {
  ...
  public ProductInterestOnlyTermNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductInterestOnlyTermNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductInterestOnlyTermNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductInterestOnlyTermNodeRuleProvider instance) {
    if (instance == null) {
