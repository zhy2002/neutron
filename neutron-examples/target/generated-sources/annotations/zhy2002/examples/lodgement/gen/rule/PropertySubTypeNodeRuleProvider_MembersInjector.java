...
public final class PropertySubTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertySubTypeNodeRuleProvider> {
  ...
  public PropertySubTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertySubTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new PropertySubTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertySubTypeNodeRuleProvider instance) {
    if (instance == null) {
