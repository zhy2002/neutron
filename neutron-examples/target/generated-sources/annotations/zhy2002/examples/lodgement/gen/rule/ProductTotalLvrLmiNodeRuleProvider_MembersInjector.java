...
public final class ProductTotalLvrLmiNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTotalLvrLmiNodeRuleProvider> {
  ...
  public ProductTotalLvrLmiNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTotalLvrLmiNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductTotalLvrLmiNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTotalLvrLmiNodeRuleProvider instance) {
    if (instance == null) {
