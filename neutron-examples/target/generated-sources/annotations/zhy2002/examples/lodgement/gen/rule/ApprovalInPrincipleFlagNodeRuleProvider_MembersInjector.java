...
public final class ApprovalInPrincipleFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<ApprovalInPrincipleFlagNodeRuleProvider> {
  ...
  public ApprovalInPrincipleFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ApprovalInPrincipleFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new ApprovalInPrincipleFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ApprovalInPrincipleFlagNodeRuleProvider instance) {
    if (instance == null) {
