...
public final class OtherAssetNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherAssetNodeRuleProvider> {
  ...
  public OtherAssetNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherAssetNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new OtherAssetNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherAssetNodeRuleProvider instance) {
    if (instance == null) {
