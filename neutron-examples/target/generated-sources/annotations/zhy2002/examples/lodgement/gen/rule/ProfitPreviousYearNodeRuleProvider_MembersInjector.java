...
public final class ProfitPreviousYearNodeRuleProvider_MembersInjector
    implements MembersInjector<ProfitPreviousYearNodeRuleProvider> {
  ...
  public ProfitPreviousYearNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProfitPreviousYearNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProfitPreviousYearNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProfitPreviousYearNodeRuleProvider instance) {
    if (instance == null) {
