...
public final class YesNoOptionNodeRuleProvider_MembersInjector<N extends YesNoOptionNode<?>>
    implements MembersInjector<YesNoOptionNodeRuleProvider<N>> {
  ...
  public YesNoOptionNodeRuleProvider_MembersInjector(
  ...
  public static <N extends YesNoOptionNode<?>>
      MembersInjector<YesNoOptionNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<PatternValidationRule> patternValidationRuleProvider,
          Provider<LengthValidationRule> lengthValidationRuleProvider,
          Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new YesNoOptionNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(YesNoOptionNodeRuleProvider<N> instance) {
    if (instance == null) {
