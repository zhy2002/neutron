...
public final class OtherIncomeNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherIncomeNodeRuleProvider> {
  ...
  public OtherIncomeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherIncomeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new OtherIncomeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherIncomeNodeRuleProvider instance) {
    if (instance == null) {
