...
public final class CountryNodeRuleProvider_MembersInjector
    implements MembersInjector<CountryNodeRuleProvider> {
  ...
  public CountryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CountryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CountryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CountryNodeRuleProvider instance) {
    if (instance == null) {
