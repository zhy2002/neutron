...
public final class ProductFeesNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductFeesNodeRuleProvider> {
  ...
  public ProductFeesNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductFeesNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new ProductFeesNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductFeesNodeRuleProvider instance) {
    if (instance == null) {
