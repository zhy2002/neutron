...
public final class PropertyWeeklyRentNodeRuleProvider_MembersInjector
    implements MembersInjector<PropertyWeeklyRentNodeRuleProvider> {
  ...
  public PropertyWeeklyRentNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PropertyWeeklyRentNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new PropertyWeeklyRentNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PropertyWeeklyRentNodeRuleProvider instance) {
    if (instance == null) {
