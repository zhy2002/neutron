...
public final class BasePercentageNodeRuleProvider_MembersInjector<N extends BasePercentageNode<?>>
    implements MembersInjector<BasePercentageNodeRuleProvider<N>> {
  ...
  public BasePercentageNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BasePercentageNode<?>>
      MembersInjector<BasePercentageNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<RangeValidationRule> rangeValidationRuleProvider,
          Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new BasePercentageNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BasePercentageNodeRuleProvider<N> instance) {
    if (instance == null) {
