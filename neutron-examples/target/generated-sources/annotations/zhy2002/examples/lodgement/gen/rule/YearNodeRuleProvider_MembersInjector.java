...
public final class YearNodeRuleProvider_MembersInjector
    implements MembersInjector<YearNodeRuleProvider> {
  ...
  public YearNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<YearNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new YearNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(YearNodeRuleProvider instance) {
    if (instance == null) {
