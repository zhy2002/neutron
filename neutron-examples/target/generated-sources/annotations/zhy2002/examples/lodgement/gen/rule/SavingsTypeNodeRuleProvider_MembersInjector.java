...
public final class SavingsTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<SavingsTypeNodeRuleProvider> {
  ...
  public SavingsTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SavingsTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new SavingsTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SavingsTypeNodeRuleProvider instance) {
    if (instance == null) {
