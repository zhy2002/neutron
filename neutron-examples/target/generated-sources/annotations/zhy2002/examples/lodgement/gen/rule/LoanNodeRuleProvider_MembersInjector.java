...
public final class LoanNodeRuleProvider_MembersInjector
    implements MembersInjector<LoanNodeRuleProvider> {
  ...
  public LoanNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<LoanNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new LoanNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(LoanNodeRuleProvider instance) {
    if (instance == null) {
