...
public final class OtherIncomeAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherIncomeAmountNodeRuleProvider> {
  ...
  public OtherIncomeAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherIncomeAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new OtherIncomeAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherIncomeAmountNodeRuleProvider instance) {
    if (instance == null) {
