...
public final class RetiredSinceNodeRuleProvider_MembersInjector
    implements MembersInjector<RetiredSinceNodeRuleProvider> {
  ...
  public RetiredSinceNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<RetiredSinceNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<MonthYearNotInFutureRule> monthYearNotInFutureRuleProvider) {
    return new RetiredSinceNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(RetiredSinceNodeRuleProvider instance) {
    if (instance == null) {
