...
public final class CompanyRegistrationStateNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyRegistrationStateNodeRuleProvider> {
  ...
  public CompanyRegistrationStateNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyRegistrationStateNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyRegistrationStateNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyRegistrationStateNodeRuleProvider instance) {
    if (instance == null) {
