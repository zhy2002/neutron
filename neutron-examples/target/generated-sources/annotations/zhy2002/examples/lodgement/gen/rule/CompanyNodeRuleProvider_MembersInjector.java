...
public final class CompanyNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyNodeRuleProvider> {
  ...
  public CompanyNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new CompanyNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyNodeRuleProvider instance) {
    if (instance == null) {
