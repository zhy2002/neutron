...
public final class MonthYearNodeRuleProvider_MembersInjector<N extends MonthYearNode<?>>
    implements MembersInjector<MonthYearNodeRuleProvider<N>> {
  ...
  public MonthYearNodeRuleProvider_MembersInjector(
  ...
  public static <N extends MonthYearNode<?>> MembersInjector<MonthYearNodeRuleProvider<N>> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<MonthYearNotInFutureRule> monthYearNotInFutureRuleProvider) {
    return new MonthYearNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(MonthYearNodeRuleProvider<N> instance) {
    if (instance == null) {
    ...
    instance.monthYearNotInFutureRuleProvider = monthYearNotInFutureRuleProvider;
  }

  public static <N extends MonthYearNode<?>> void injectMonthYearNotInFutureRuleProvider(
      MonthYearNodeRuleProvider<N> instance,
      Provider<MonthYearNotInFutureRule> monthYearNotInFutureRuleProvider) {
    instance.monthYearNotInFutureRuleProvider = monthYearNotInFutureRuleProvider;
  }
}
