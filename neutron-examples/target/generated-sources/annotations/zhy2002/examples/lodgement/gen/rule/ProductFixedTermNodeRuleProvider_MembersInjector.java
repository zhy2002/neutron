...
public final class ProductFixedTermNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductFixedTermNodeRuleProvider> {
  ...
  public ProductFixedTermNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductFixedTermNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductFixedTermNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductFixedTermNodeRuleProvider instance) {
    if (instance == null) {
