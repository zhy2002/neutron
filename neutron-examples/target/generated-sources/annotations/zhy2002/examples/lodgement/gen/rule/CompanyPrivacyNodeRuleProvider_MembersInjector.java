...
public final class CompanyPrivacyNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyPrivacyNodeRuleProvider> {
  ...
  public CompanyPrivacyNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyPrivacyNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new CompanyPrivacyNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyPrivacyNodeRuleProvider instance) {
    if (instance == null) {
