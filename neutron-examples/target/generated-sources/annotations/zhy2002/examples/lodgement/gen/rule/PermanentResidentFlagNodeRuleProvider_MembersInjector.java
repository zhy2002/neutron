...
public final class PermanentResidentFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<PermanentResidentFlagNodeRuleProvider> {
  ...
  public PermanentResidentFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PermanentResidentFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new PermanentResidentFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PermanentResidentFlagNodeRuleProvider instance) {
    if (instance == null) {
