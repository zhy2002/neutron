...
public final class ProductFeaturesNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductFeaturesNodeRuleProvider> {
  ...
  public ProductFeaturesNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductFeaturesNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new ProductFeaturesNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductFeaturesNodeRuleProvider instance) {
    if (instance == null) {
