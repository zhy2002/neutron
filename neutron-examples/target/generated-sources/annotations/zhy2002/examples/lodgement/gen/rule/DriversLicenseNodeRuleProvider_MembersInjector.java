...
public final class DriversLicenseNodeRuleProvider_MembersInjector
    implements MembersInjector<DriversLicenseNodeRuleProvider> {
  ...
  public DriversLicenseNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<DriversLicenseNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new DriversLicenseNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(DriversLicenseNodeRuleProvider instance) {
    if (instance == null) {
