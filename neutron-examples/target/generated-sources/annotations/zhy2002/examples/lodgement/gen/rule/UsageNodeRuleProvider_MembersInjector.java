...
public final class UsageNodeRuleProvider_MembersInjector
    implements MembersInjector<UsageNodeRuleProvider> {
  ...
  public UsageNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<UsageNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new UsageNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(UsageNodeRuleProvider instance) {
    if (instance == null) {
