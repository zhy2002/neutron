...
public final class OccupationNodeRuleProvider_MembersInjector
    implements MembersInjector<OccupationNodeRuleProvider> {
  ...
  public OccupationNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OccupationNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new OccupationNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OccupationNodeRuleProvider instance) {
    if (instance == null) {
