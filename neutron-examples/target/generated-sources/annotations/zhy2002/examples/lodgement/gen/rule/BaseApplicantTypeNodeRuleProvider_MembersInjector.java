...
public final class BaseApplicantTypeNodeRuleProvider_MembersInjector<
        N extends BaseApplicantTypeNode<?>>
    implements MembersInjector<BaseApplicantTypeNodeRuleProvider<N>> {
  ...
  public BaseApplicantTypeNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseApplicantTypeNode<?>>
      MembersInjector<BaseApplicantTypeNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<PatternValidationRule> patternValidationRuleProvider,
          Provider<LengthValidationRule> lengthValidationRuleProvider,
          Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new BaseApplicantTypeNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseApplicantTypeNodeRuleProvider<N> instance) {
    if (instance == null) {
