...
public final class AddressRefNodeRuleProvider_MembersInjector
    implements MembersInjector<AddressRefNodeRuleProvider> {
  ...
  public AddressRefNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AddressRefNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<NodeReferenceChangeRule> nodeReferenceChangeRuleProvider) {
    return new AddressRefNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AddressRefNodeRuleProvider instance) {
    if (instance == null) {
