...
public final class BaseCurrencyNodeRuleProvider_MembersInjector<N extends BaseCurrencyNode<?>>
    implements MembersInjector<BaseCurrencyNodeRuleProvider<N>> {
  ...
  public BaseCurrencyNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseCurrencyNode<?>>
      MembersInjector<BaseCurrencyNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<RangeValidationRule> rangeValidationRuleProvider,
          Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new BaseCurrencyNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseCurrencyNodeRuleProvider<N> instance) {
    if (instance == null) {
