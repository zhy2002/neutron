...
public final class OtherAssetMarketValueNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherAssetMarketValueNodeRuleProvider> {
  ...
  public OtherAssetMarketValueNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherAssetMarketValueNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new OtherAssetMarketValueNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherAssetMarketValueNodeRuleProvider instance) {
    if (instance == null) {
