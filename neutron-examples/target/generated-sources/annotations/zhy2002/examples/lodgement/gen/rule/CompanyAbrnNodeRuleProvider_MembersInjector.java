...
public final class CompanyAbrnNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyAbrnNodeRuleProvider> {
  ...
  public CompanyAbrnNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyAbrnNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyAbrnNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyAbrnNodeRuleProvider instance) {
    if (instance == null) {
