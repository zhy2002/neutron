...
public final class CompanyIndustryNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyIndustryNodeRuleProvider> {
  ...
  public CompanyIndustryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyIndustryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyIndustryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyIndustryNodeRuleProvider instance) {
    if (instance == null) {
