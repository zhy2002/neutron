...
public final class OwnershipNodeRuleProvider_MembersInjector
    implements MembersInjector<OwnershipNodeRuleProvider> {
  ...
  public OwnershipNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OwnershipNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new OwnershipNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OwnershipNodeRuleProvider instance) {
    if (instance == null) {
