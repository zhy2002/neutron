...
public final class TrustAddressNodeRuleProvider_MembersInjector
    implements MembersInjector<TrustAddressNodeRuleProvider> {
  ...
  public TrustAddressNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TrustAddressNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new TrustAddressNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TrustAddressNodeRuleProvider instance) {
    if (instance == null) {
