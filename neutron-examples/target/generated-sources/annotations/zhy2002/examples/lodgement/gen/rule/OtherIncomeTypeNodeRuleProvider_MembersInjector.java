...
public final class OtherIncomeTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherIncomeTypeNodeRuleProvider> {
  ...
  private final Provider<OtherIncomeTypeChangeRule> otherIncomeTypeChangeRuleProvider;

  public OtherIncomeTypeNodeRuleProvider_MembersInjector(
    ...
    assert otherIncomeTypeChangeRuleProvider != null;
    this.otherIncomeTypeChangeRuleProvider = otherIncomeTypeChangeRuleProvider;
  }

  public static MembersInjector<OtherIncomeTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<OtherIncomeTypeChangeRule> otherIncomeTypeChangeRuleProvider) {
    return new OtherIncomeTypeNodeRuleProvider_MembersInjector(
        ...
        otherIncomeTypeChangeRuleProvider);
  }

  @Override
  public void injectMembers(OtherIncomeTypeNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.otherIncomeTypeChangeRuleProvider = otherIncomeTypeChangeRuleProvider;
  }

  public static void injectOtherIncomeTypeChangeRuleProvider(
      OtherIncomeTypeNodeRuleProvider instance,
      Provider<OtherIncomeTypeChangeRule> otherIncomeTypeChangeRuleProvider) {
    instance.otherIncomeTypeChangeRuleProvider = otherIncomeTypeChangeRuleProvider;
  }
}
