...
public final class LoanClearingFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<LoanClearingFlagNodeRuleProvider> {
  ...
  public LoanClearingFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<LoanClearingFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new LoanClearingFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(LoanClearingFlagNodeRuleProvider instance) {
    if (instance == null) {
