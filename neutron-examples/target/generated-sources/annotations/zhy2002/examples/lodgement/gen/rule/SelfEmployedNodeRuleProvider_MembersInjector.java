...
public final class SelfEmployedNodeRuleProvider_MembersInjector
    implements MembersInjector<SelfEmployedNodeRuleProvider> {
  ...
  public SelfEmployedNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SelfEmployedNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new SelfEmployedNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SelfEmployedNodeRuleProvider instance) {
    if (instance == null) {
