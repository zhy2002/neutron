...
public final class AssetsNodeRuleProvider_MembersInjector
    implements MembersInjector<AssetsNodeRuleProvider> {
  ...
  public AssetsNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AssetsNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new AssetsNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AssetsNodeRuleProvider instance) {
    if (instance == null) {
