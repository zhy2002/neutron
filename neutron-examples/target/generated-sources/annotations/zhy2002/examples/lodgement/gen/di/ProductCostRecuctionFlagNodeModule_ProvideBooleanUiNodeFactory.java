...
public final class ProductCostRecuctionFlagNodeModule_ProvideBooleanUiNodeFactory
    implements Factory<BooleanUiNode<?>> {
  private final ProductCostRecuctionFlagNodeModule module;

  public ProductCostRecuctionFlagNodeModule_ProvideBooleanUiNodeFactory(
  ...
  public static Factory<BooleanUiNode<?>> create(ProductCostRecuctionFlagNodeModule module) {
    return new ProductCostRecuctionFlagNodeModule_ProvideBooleanUiNodeFactory(module);
  }

  /** Proxies {@link ProductCostRecuctionFlagNodeModule#provideBooleanUiNode()}. */
