...
public final class ProductCardHolderNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductCardHolderNodeRuleProvider> {
  ...
  public ProductCardHolderNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductCardHolderNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new ProductCardHolderNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductCardHolderNodeRuleProvider instance) {
    if (instance == null) {
