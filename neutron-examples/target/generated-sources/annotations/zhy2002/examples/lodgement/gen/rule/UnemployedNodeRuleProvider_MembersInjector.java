...
public final class UnemployedNodeRuleProvider_MembersInjector
    implements MembersInjector<UnemployedNodeRuleProvider> {
  ...
  public UnemployedNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<UnemployedNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new UnemployedNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(UnemployedNodeRuleProvider instance) {
    if (instance == null) {
