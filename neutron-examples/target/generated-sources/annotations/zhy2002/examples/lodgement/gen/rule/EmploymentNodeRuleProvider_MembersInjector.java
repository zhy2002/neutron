...
public final class EmploymentNodeRuleProvider_MembersInjector<N extends EmploymentNode<?>>
    implements MembersInjector<EmploymentNodeRuleProvider<N>> {
  ...
  public EmploymentNodeRuleProvider_MembersInjector(
  ...
  public static <N extends EmploymentNode<?>> MembersInjector<EmploymentNodeRuleProvider<N>> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new EmploymentNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(EmploymentNodeRuleProvider<N> instance) {
    if (instance == null) {
