...
public final class ProductTotalSecurityAmountNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTotalSecurityAmountNodeRuleProvider> {
  ...
  public ProductTotalSecurityAmountNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTotalSecurityAmountNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductTotalSecurityAmountNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTotalSecurityAmountNodeRuleProvider instance) {
    if (instance == null) {
