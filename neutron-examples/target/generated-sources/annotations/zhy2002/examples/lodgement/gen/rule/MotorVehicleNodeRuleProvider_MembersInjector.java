...
public final class MotorVehicleNodeRuleProvider_MembersInjector
    implements MembersInjector<MotorVehicleNodeRuleProvider> {
  ...
  public MotorVehicleNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<MotorVehicleNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new MotorVehicleNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(MotorVehicleNodeRuleProvider instance) {
    if (instance == null) {
