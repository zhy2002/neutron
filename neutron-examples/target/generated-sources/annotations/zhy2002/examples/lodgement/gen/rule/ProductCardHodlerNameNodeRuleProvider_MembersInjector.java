...
public final class ProductCardHodlerNameNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductCardHodlerNameNodeRuleProvider> {
  ...
  public ProductCardHodlerNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductCardHodlerNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductCardHodlerNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductCardHodlerNameNodeRuleProvider instance) {
    if (instance == null) {
