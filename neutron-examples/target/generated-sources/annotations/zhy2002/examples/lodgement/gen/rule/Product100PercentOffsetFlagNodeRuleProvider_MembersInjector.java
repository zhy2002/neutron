...
public final class Product100PercentOffsetFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<Product100PercentOffsetFlagNodeRuleProvider> {
  ...
  public Product100PercentOffsetFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<Product100PercentOffsetFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new Product100PercentOffsetFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(Product100PercentOffsetFlagNodeRuleProvider instance) {
    if (instance == null) {
