...
public final class AccessCompanyNameNodeRuleProvider_MembersInjector
    implements MembersInjector<AccessCompanyNameNodeRuleProvider> {
  ...
  public AccessCompanyNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AccessCompanyNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new AccessCompanyNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AccessCompanyNameNodeRuleProvider instance) {
    if (instance == null) {
