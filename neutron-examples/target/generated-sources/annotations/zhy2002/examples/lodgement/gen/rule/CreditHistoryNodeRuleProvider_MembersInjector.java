...
public final class CreditHistoryNodeRuleProvider_MembersInjector
    implements MembersInjector<CreditHistoryNodeRuleProvider> {
  ...
  public CreditHistoryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CreditHistoryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CreditHistoryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CreditHistoryNodeRuleProvider instance) {
    if (instance == null) {
