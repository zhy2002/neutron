...
public final class TrustBeneficiaryClassNodeRuleProvider_MembersInjector
    implements MembersInjector<TrustBeneficiaryClassNodeRuleProvider> {
  ...
  public TrustBeneficiaryClassNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TrustBeneficiaryClassNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new TrustBeneficiaryClassNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TrustBeneficiaryClassNodeRuleProvider instance) {
    if (instance == null) {
