...
public final class EmployerAddressNodeRuleProvider_MembersInjector
    implements MembersInjector<EmployerAddressNodeRuleProvider> {
  ...
  public EmployerAddressNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<EmployerAddressNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider,
      Provider<UpdateAddressRefListRule> updateAddressRefListRuleProvider) {
    return new EmployerAddressNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(EmployerAddressNodeRuleProvider instance) {
    if (instance == null) {
