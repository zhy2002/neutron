...
public final class EmployedNodeRuleProvider_MembersInjector<N extends EmployedNode>
    implements MembersInjector<EmployedNodeRuleProvider<N>> {
  ...
  public EmployedNodeRuleProvider_MembersInjector(
  ...
  public static <N extends EmployedNode> MembersInjector<EmployedNodeRuleProvider<N>> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new EmployedNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(EmployedNodeRuleProvider<N> instance) {
    if (instance == null) {
