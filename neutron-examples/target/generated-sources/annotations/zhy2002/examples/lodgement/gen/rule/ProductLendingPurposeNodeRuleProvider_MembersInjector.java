...
public final class ProductLendingPurposeNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductLendingPurposeNodeRuleProvider> {
  ...
  public ProductLendingPurposeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductLendingPurposeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductLendingPurposeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductLendingPurposeNodeRuleProvider instance) {
    if (instance == null) {
