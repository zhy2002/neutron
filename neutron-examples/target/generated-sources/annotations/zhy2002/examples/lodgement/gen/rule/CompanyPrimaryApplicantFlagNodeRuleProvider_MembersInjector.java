...
public final class CompanyPrimaryApplicantFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyPrimaryApplicantFlagNodeRuleProvider> {
  ...
  public CompanyPrimaryApplicantFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyPrimaryApplicantFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new CompanyPrimaryApplicantFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyPrimaryApplicantFlagNodeRuleProvider instance) {
    if (instance == null) {
