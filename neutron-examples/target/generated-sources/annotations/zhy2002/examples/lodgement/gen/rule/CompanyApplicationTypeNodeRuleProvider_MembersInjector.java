...
public final class CompanyApplicationTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyApplicationTypeNodeRuleProvider> {
  ...
  public CompanyApplicationTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyApplicationTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyApplicationTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyApplicationTypeNodeRuleProvider instance) {
    if (instance == null) {
