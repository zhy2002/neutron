...
public final class TrustIndustryNodeRuleProvider_MembersInjector
    implements MembersInjector<TrustIndustryNodeRuleProvider> {
  ...
  public TrustIndustryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TrustIndustryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new TrustIndustryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TrustIndustryNodeRuleProvider instance) {
    if (instance == null) {
