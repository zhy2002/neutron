...
public final class CompanyTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyTypeNodeRuleProvider> {
  ...
  public CompanyTypeNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyTypeNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyTypeNodeRuleProvider instance) {
    if (instance == null) {
