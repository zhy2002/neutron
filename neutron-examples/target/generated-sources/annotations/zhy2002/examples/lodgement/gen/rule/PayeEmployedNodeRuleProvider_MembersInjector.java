...
public final class PayeEmployedNodeRuleProvider_MembersInjector
    implements MembersInjector<PayeEmployedNodeRuleProvider> {
  ...
  public PayeEmployedNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PayeEmployedNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new PayeEmployedNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PayeEmployedNodeRuleProvider instance) {
    if (instance == null) {
