...
public final class ThirdPartyWorkPhoneNodeRuleProvider_MembersInjector
    implements MembersInjector<ThirdPartyWorkPhoneNodeRuleProvider> {
  ...
  public ThirdPartyWorkPhoneNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ThirdPartyWorkPhoneNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<TelephoneCompleteRule> telephoneCompleteRuleProvider) {
    return new ThirdPartyWorkPhoneNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ThirdPartyWorkPhoneNodeRuleProvider instance) {
    if (instance == null) {
