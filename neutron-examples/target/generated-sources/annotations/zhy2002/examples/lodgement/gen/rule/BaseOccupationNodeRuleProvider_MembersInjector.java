...
public final class BaseOccupationNodeRuleProvider_MembersInjector<N extends BaseOccupationNode<?>>
    implements MembersInjector<BaseOccupationNodeRuleProvider<N>> {
  ...
  public BaseOccupationNodeRuleProvider_MembersInjector(
  ...
  public static <N extends BaseOccupationNode<?>>
      MembersInjector<BaseOccupationNodeRuleProvider<N>> create(
          Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
          Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
          Provider<PatternValidationRule> patternValidationRuleProvider,
          Provider<LengthValidationRule> lengthValidationRuleProvider,
          Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new BaseOccupationNodeRuleProvider_MembersInjector<N>(
  ...
  @Override
  public void injectMembers(BaseOccupationNodeRuleProvider<N> instance) {
    if (instance == null) {
