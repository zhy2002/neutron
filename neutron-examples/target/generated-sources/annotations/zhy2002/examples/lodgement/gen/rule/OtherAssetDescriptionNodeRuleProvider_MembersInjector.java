...
public final class OtherAssetDescriptionNodeRuleProvider_MembersInjector
    implements MembersInjector<OtherAssetDescriptionNodeRuleProvider> {
  ...
  public OtherAssetDescriptionNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OtherAssetDescriptionNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new OtherAssetDescriptionNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OtherAssetDescriptionNodeRuleProvider instance) {
    if (instance == null) {
