...
public final class ApplicationTypeNodeRuleProvider_MembersInjector
    implements MembersInjector<ApplicationTypeNodeRuleProvider> {
  ...
  private final Provider<ChangeApplicationTypeRule> changeApplicationTypeRuleProvider;

  public ApplicationTypeNodeRuleProvider_MembersInjector(
    ...
    assert changeApplicationTypeRuleProvider != null;
    this.changeApplicationTypeRuleProvider = changeApplicationTypeRuleProvider;
  }

  public static MembersInjector<ApplicationTypeNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider,
      Provider<ChangeApplicationTypeRule> changeApplicationTypeRuleProvider) {
    return new ApplicationTypeNodeRuleProvider_MembersInjector(
        ...
        changeApplicationTypeRuleProvider);
  }

  @Override
  public void injectMembers(ApplicationTypeNodeRuleProvider instance) {
    if (instance == null) {
    ...
    instance.changeApplicationTypeRuleProvider = changeApplicationTypeRuleProvider;
  }

  public static void injectChangeApplicationTypeRuleProvider(
      ApplicationTypeNodeRuleProvider instance,
      Provider<ChangeApplicationTypeRule> changeApplicationTypeRuleProvider) {
    instance.changeApplicationTypeRuleProvider = changeApplicationTypeRuleProvider;
  }
}
