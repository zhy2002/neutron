...
public final class SavingsBalanceNodeRuleProvider_MembersInjector
    implements MembersInjector<SavingsBalanceNodeRuleProvider> {
  ...
  public SavingsBalanceNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<SavingsBalanceNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new SavingsBalanceNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(SavingsBalanceNodeRuleProvider instance) {
    if (instance == null) {
