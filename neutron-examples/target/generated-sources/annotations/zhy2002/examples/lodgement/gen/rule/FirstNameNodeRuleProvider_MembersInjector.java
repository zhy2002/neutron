...
public final class FirstNameNodeRuleProvider_MembersInjector
    implements MembersInjector<FirstNameNodeRuleProvider> {
  ...
  public FirstNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<FirstNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new FirstNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(FirstNameNodeRuleProvider instance) {
    if (instance == null) {
