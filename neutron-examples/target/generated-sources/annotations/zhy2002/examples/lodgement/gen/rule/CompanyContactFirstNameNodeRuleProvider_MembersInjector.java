...
public final class CompanyContactFirstNameNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyContactFirstNameNodeRuleProvider> {
  ...
  public CompanyContactFirstNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyContactFirstNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new CompanyContactFirstNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyContactFirstNameNodeRuleProvider instance) {
    if (instance == null) {
