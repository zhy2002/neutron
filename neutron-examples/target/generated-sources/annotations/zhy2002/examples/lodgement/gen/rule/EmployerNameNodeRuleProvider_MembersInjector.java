...
public final class EmployerNameNodeRuleProvider_MembersInjector
    implements MembersInjector<EmployerNameNodeRuleProvider> {
  ...
  public EmployerNameNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<EmployerNameNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new EmployerNameNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(EmployerNameNodeRuleProvider instance) {
    if (instance == null) {
