...
public final class CompanyTrustNodeRuleProvider_MembersInjector
    implements MembersInjector<CompanyTrustNodeRuleProvider> {
  ...
  public CompanyTrustNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<CompanyTrustNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new CompanyTrustNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(CompanyTrustNodeRuleProvider instance) {
    if (instance == null) {
