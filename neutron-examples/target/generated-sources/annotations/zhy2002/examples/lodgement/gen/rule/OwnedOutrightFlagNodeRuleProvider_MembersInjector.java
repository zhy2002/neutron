...
public final class OwnedOutrightFlagNodeRuleProvider_MembersInjector
    implements MembersInjector<OwnedOutrightFlagNodeRuleProvider> {
  ...
  public OwnedOutrightFlagNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<OwnedOutrightFlagNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<BooleanFixedValueValidationRule> booleanFixedValueValidationRuleProvider) {
    return new OwnedOutrightFlagNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(OwnedOutrightFlagNodeRuleProvider instance) {
    if (instance == null) {
