...
public final class ProductOptOutReasonNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductOptOutReasonNodeRuleProvider> {
  ...
  public ProductOptOutReasonNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductOptOutReasonNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new ProductOptOutReasonNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductOptOutReasonNodeRuleProvider instance) {
    if (instance == null) {
