...
public final class PersonGeneralNodeRuleProvider_MembersInjector
    implements MembersInjector<PersonGeneralNodeRuleProvider> {
  ...
  public PersonGeneralNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<PersonGeneralNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new PersonGeneralNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(PersonGeneralNodeRuleProvider instance) {
    if (instance == null) {
