...
public final class TrustCountryNodeRuleProvider_MembersInjector
    implements MembersInjector<TrustCountryNodeRuleProvider> {
  ...
  public TrustCountryNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<TrustCountryNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<PatternValidationRule> patternValidationRuleProvider,
      Provider<LengthValidationRule> lengthValidationRuleProvider,
      Provider<InvalidCharPreChangeRule> invalidCharPreChangeRuleProvider) {
    return new TrustCountryNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(TrustCountryNodeRuleProvider instance) {
    if (instance == null) {
