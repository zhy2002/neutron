...
public final class RealEstateNodeRuleProvider_MembersInjector
    implements MembersInjector<RealEstateNodeRuleProvider> {
  ...
  public RealEstateNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<RealEstateNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new RealEstateNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(RealEstateNodeRuleProvider instance) {
    if (instance == null) {
