...
public final class ProductTotalLvrNodeRuleProvider_MembersInjector
    implements MembersInjector<ProductTotalLvrNodeRuleProvider> {
  ...
  public ProductTotalLvrNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<ProductTotalLvrNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<LeafValueRequiredValidationRule> leafValueRequiredValidationRuleProvider,
      Provider<RangeValidationRule> rangeValidationRuleProvider,
      Provider<NumberFormatValidationRule> numberFormatValidationRuleProvider) {
    return new ProductTotalLvrNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(ProductTotalLvrNodeRuleProvider instance) {
    if (instance == null) {
