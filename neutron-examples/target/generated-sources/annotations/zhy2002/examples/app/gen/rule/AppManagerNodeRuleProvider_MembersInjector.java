...
public final class AppManagerNodeRuleProvider_MembersInjector
    implements MembersInjector<AppManagerNodeRuleProvider> {
  ...
  public AppManagerNodeRuleProvider_MembersInjector(
  ...
  public static MembersInjector<AppManagerNodeRuleProvider> create(
      Provider<ClearErrorsForDisabledNodeRule> clearErrorsForDisabledNodeRuleProvider,
      Provider<ObjectValueRequiredValidationRule> objectValueRequiredValidationRuleProvider,
      Provider<UpdateObjectHasValueRule> updateObjectHasValueRuleProvider) {
    return new AppManagerNodeRuleProvider_MembersInjector(
  ...
  @Override
  public void injectMembers(AppManagerNodeRuleProvider instance) {
    if (instance == null) {
