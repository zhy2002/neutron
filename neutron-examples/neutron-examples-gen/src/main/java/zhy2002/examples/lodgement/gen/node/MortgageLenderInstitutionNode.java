...
public class MortgageLenderInstitutionNode extends StringUiNode<ExistingMortgageNode> {
    ...
    @Inject
    public MortgageLenderInstitutionNode(@Owner ExistingMortgageNode parent, @ChildName String name) {
        super(parent, name);
    }
    ...
    protected final MortgageLenderInstitutionNodeComponent getComponent() {
        return component;
    }
