...
public class ProductFixedTermNode extends BigDecimalUiNode<ProductDescriptionNode> {
    ...
    public static final PropertyMetadata<UnitSymbol> SUFFIX_SYMBOL_PROPERTY = MetadataRegistry.createProperty(ProductFixedTermNode.class, "suffixSymbol", UnitSymbol.class, ApplicationNodeConstants.YEAR);
