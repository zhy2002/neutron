...
public class NabSelectRelatedPersonListNodeRuleProvider extends SelectRelatedPersonListNodeRuleProvider {

    @Inject
    public NabSelectRelatedPersonListNodeRuleProvider() {
    }
