...
public class AnzSelectAccountHolderListNodeRuleProvider extends SelectAccountHolderListNodeRuleProvider {

    @Inject
    public AnzSelectAccountHolderListNodeRuleProvider() {
    }
