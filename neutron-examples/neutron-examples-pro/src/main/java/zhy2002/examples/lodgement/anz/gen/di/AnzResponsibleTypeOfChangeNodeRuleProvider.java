...
public class AnzResponsibleTypeOfChangeNodeRuleProvider extends ResponsibleTypeOfChangeNodeRuleProvider {

    @Inject
    public AnzResponsibleTypeOfChangeNodeRuleProvider() {
    }
