...
public class NabSelectAccountHolderListNodeRuleProvider extends SelectAccountHolderListNodeRuleProvider {

    @Inject
    public NabSelectAccountHolderListNodeRuleProvider() {
    }
