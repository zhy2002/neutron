...
public class AnzResponsibleMitigationMethodNodeRuleProvider extends ResponsibleMitigationMethodNodeRuleProvider {

    @Inject
    public AnzResponsibleMitigationMethodNodeRuleProvider() {
    }
