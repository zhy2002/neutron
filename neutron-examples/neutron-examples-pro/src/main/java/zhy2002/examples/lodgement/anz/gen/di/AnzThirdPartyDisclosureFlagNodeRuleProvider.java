...
public class AnzThirdPartyDisclosureFlagNodeRuleProvider extends ThirdPartyDisclosureFlagNodeRuleProvider {

    @Inject
    public AnzThirdPartyDisclosureFlagNodeRuleProvider() {
    }
