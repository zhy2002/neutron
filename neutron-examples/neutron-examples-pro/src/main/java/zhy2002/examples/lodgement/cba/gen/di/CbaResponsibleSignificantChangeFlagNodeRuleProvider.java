...
public class CbaResponsibleSignificantChangeFlagNodeRuleProvider extends ResponsibleSignificantChangeFlagNodeRuleProvider {

    @Inject
    public CbaResponsibleSignificantChangeFlagNodeRuleProvider() {
    }
