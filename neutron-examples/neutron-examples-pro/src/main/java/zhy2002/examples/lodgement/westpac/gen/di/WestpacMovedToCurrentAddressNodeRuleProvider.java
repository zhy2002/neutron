...
public class WestpacMovedToCurrentAddressNodeRuleProvider extends MovedToCurrentAddressNodeRuleProvider {

    @Inject
    public WestpacMovedToCurrentAddressNodeRuleProvider() {
    }
