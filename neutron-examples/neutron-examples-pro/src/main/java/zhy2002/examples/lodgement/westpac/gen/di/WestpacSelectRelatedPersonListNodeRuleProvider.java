...
public class WestpacSelectRelatedPersonListNodeRuleProvider extends SelectRelatedPersonListNodeRuleProvider {

    @Inject
    public WestpacSelectRelatedPersonListNodeRuleProvider() {
    }
