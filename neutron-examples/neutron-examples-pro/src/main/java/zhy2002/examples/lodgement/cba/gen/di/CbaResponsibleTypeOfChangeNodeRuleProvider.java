...
public class CbaResponsibleTypeOfChangeNodeRuleProvider extends ResponsibleTypeOfChangeNodeRuleProvider {

    @Inject
    public CbaResponsibleTypeOfChangeNodeRuleProvider() {
    }
