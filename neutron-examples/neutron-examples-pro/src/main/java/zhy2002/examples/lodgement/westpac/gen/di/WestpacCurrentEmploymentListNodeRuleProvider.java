...
public class WestpacCurrentEmploymentListNodeRuleProvider extends CurrentEmploymentListNodeRuleProvider {

    @Inject
    public WestpacCurrentEmploymentListNodeRuleProvider() {
    }
