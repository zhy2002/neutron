...
public class WestpacOtherIncomeAddBackTypeNodeRuleProvider extends OtherIncomeAddBackTypeNodeRuleProvider {

    @Inject
    public WestpacOtherIncomeAddBackTypeNodeRuleProvider() {
    }
