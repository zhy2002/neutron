...
public class CbaThirdPartyDisclosureFlagNodeRuleProvider extends ThirdPartyDisclosureFlagNodeRuleProvider {

    @Inject
    public CbaThirdPartyDisclosureFlagNodeRuleProvider() {
    }
