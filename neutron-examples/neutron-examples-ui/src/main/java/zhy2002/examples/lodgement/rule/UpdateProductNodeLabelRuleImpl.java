...
import zhy2002.examples.lodgement.gen.rule.UpdateProductNodeLabelRule;
...
public class UpdateProductNodeLabelRuleImpl extends UpdateProductNodeLabelRule {

    @Inject
    public UpdateProductNodeLabelRuleImpl(@Owner ProductNode owner) {
        super(owner);
    }
