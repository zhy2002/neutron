...
import zhy2002.examples.lodgement.gen.rule.UsedAsSecurityFlagChangeRule;
...
public class UsedAsSecurityFlagChangeRuleImpl extends UsedAsSecurityFlagChangeRule {

    @Inject
    public UsedAsSecurityFlagChangeRuleImpl(@Owner UsedAsSecurityFlagNode owner) {
        super(owner);
    }
